...
- **Migrações aplicadas**: `conteudo/0012-0040` + `painel/0002-0003` + `inteligencia/0002`. Migração **`conteudo/0040`** (campos `icone_largura`/`icone_altura` em `ColunaExtraBotao`, extensão da parte 37, 2026-07-22) é a mais recente. Anterior a ela: **`conteudo/0039`** (campos `icone_largura`/`icone_altura` em Categoria, parte 37, 2026-07-22). Anterior a ela: **`conteudo/0038`** (todos os campos `URLField` sem `max_length` explícito passaram para 1000 chars — corrige `DataError` no sync com Postgres/Docker, links longos como SharePoint). Anterior a ela: **`conteudo/0037`** (`Anexo.url` novo campo + `arquivo`/`nome` viram opcionais, parte 36, 2026-07-22).

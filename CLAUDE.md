...
16. **Parte 2 do dia (após os créditos voltarem)** — plano do PPTX "acertar a home page espaco" + pedidos por texto:
    ...
    - **Carrossel coluna cheia**: sem NENHUM cartaz ativo (dos dois lados), a view manda `sem_cartazes` e o template põe `col-cheia` nas colunas laterais → o carrossel estica para `calc(100vh - 104px)` com `height:100% !important` (vence o tamanho do admin), preso (sticky) como os cartazes. Com cartaz presente, comportamento antigo intacto.

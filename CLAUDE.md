# Site Currículos SEDU — Contexto do Projeto (v29 — atualizado em 2026-07-21 — Parte 33)
...
- **Migrações aplicadas**: `conteudo/0012-0035` + `painel/0002-0003` + `inteligencia/0002`. Migração **`conteudo/0035`** (`Comentario.categoria` opcional, ao lado de `Comentario.conteudo` que virou opcional também — FK dual mutuamente exclusiva) é a mais recente (parte 33, 2026-07-21). **Nenhuma migração nova na parte 29** (Docker é apenas infraestrutura, não toca modelos).

# Site Currículos SEDU — Contexto do Projeto (v31 — atualizado em 2026-07-22 — Parte 36)
...
- **Migrações aplicadas**: `conteudo/0012-0037` + `painel/0002-0003` + `inteligencia/0002`. Migração **`conteudo/0037`** (`Anexo.url` novo campo + `arquivo`/`nome` viram opcionais, parte 36, 2026-07-22) é a mais recente. Anterior a ela: **`conteudo/0036`** (`ColunaExtra.titulo` CharField→TextField, parte 34, 2026-07-22).

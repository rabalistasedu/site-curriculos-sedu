# Site Currículos SEDU — Contexto do Projeto (v42 — atualizado em 2026-07-23 — Parte 41: Lixeira/Recuperação em 30 dias (Categoria + Conteúdo) ✅ TESTADA + Recuperação emergencial de "Orientações Curriculares")
...
- **Migrações aplicadas**: `conteudo/0012-0044` + `painel/0002-0003` + `inteligencia/0002`. **Cronologia das mais recentes (Parte 41 + Parte 39 + Parte 37 + Parte 36 + correções)**: 

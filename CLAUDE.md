# Site Currículos SEDU — Contexto do Projeto (v28 — atualizado em 2026-07-21 — Parte 32)
...
- **Migrações aplicadas**: `conteudo/0012-0034` + `painel/0002-0003` + `inteligencia/0002`. Migração **`conteudo/0034`** (modelo `RodapeImagem` + 10 campos novos em `ConfiguracaoSite` para identidade visual cabeçalho + nome Currículo Atual customizável) é a mais recente (parte 32, 2026-07-21). **Nenhuma migração nova na parte 29** (Docker é apenas infraestrutura, não toca modelos).

# Site Currículos SEDU — Contexto do Projeto (v32.1 — atualizado em 2026-07-22 — Parte 36 + Correções Finais URLFields + Rótulo "Botão")
...
- **Migrações aplicadas**: `conteudo/0012-0038` + `painel/0002-0003` + `inteligencia/0002`. Migração **`conteudo/0038`** (todos os campos `URLField` sem `max_length` explícito passaram para 1000 chars — corrige `DataError` no sync com Postgres/Docker, links longos como SharePoint) é a mais recente. Anterior a ela: **`conteudo/0037`** (`Anexo.url` novo campo + `arquivo`/`nome` viram opcionais, parte 36, 2026-07-22) é a mais recente. Anterior a ela: **`conteudo/0036`** (`ColunaExtra.titulo` CharField→TextField, parte 34, 2026-07-22).

# Site Currículos SEDU — Contexto do Projeto (v34 — atualizado em 2026-07-23 — Parte 38: Contador de Comentários Pendentes no Admin)
...
- **Migrações aplicadas**: `conteudo/0012-0041` + `painel/0002-0003` + `inteligencia/0002`. **Cronologia das mais recentes (Parte 37 + Parte 36 + correções, 2026-07-22)**: 
...
conteudo/                # App principal do site
  ...
  migrations/            # 0001 inicial → 0041 (icone_largura/altura em ColunaExtra, parte 37)

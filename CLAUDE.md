# Site Currículos SEDU — Contexto do Projeto (v41 — atualizado em 2026-07-23 — Parte 40 CONCLUÍDA: Ação "Mover" + Balãozinho de Comentários no Menu Lateral ✅ TESTADA)
...
- **Leva mais recente (2026-07-23 — "parte 40" COMPLETA)**: **Ação "Mover" no Django Admin (Conteúdo e Categoria) + Balãozinho de Comentários Pendentes no Menu Lateral Esquerdo** — o Dan pediu 2 implementações: 
...
- **Migrações aplicadas**: `conteudo/0012-0042` + `painel/0002-0003` + `inteligencia/0002`. **Cronologia das mais recentes (Parte 39 + Parte 37 + Parte 36 + correções)**: 

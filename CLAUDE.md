...
- **Leva mais recente (2026-07-12 — "parte 4")**: **Rodapé sticky corrigido** — em páginas com pouco conteúdo (busca vazia, categorias vazias), o rodapé agora cola no fundo da viewport em vez de "flutuar" no meio. Implementado com flexbox no body + flex: 1 no main. Histórico completo no bloco "Histórico de implementação" item 18.
